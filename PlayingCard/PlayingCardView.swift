...
class PlayingCardView: UIView {
    ...
    private func configureCorneLabel(_ label: UILabel) {
    ...
    override func layoutSubviews() {
        ...
        configureCorneLabel(upperLeftCornerLabel)
        upperLeftCornerLabel.frame.origin = bounds.origin.offsetBy(dx: cornerOffset, dy: cornerOffset)
        
        configureCorneLabel(lowerRightCornerLabel)
...
extension Bundle {
    public static let myFramework = Bundle(identifier: "com.uisameer.PlayingCard")
}
